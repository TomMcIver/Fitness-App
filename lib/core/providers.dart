...
class UserProfileNotifier extends StateNotifier<UserProfile?> {
  ...
  void updateCircumference(String name, double valueCm) {
    final cur = state;
    if (cur == null) return;
    final newCirc = Map<String, double>.from(cur.circumferences)..[name] = valueCm;
...
final dailyLogProvider =
    StateNotifierProvider<DailyLogNotifier, DailyLog>((ref) => DailyLogNotifier());
...
DateTime _today() { final n = DateTime.now(); return DateTime(n.year, n.month, n.day); }
